print("---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ----")
print("---- [Coykn3] : https://discord.gg/Qq75dxFjxq ----")
print("---- ---- Pour tout support, discord  ---- ----")
print("---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ----")
...
RegisterServerEvent("coykn3_logs:SendLogs")
AddEventHandler("coykn3_logs:SendLogs", function(Type, Color, Title, Description)
